 ...
 */
abstract contract ERC721Tradable is ContentMixin, ERC721Enumerable, NativeMetaTransaction, Ownable {
    using SafeMath for uint256;
...
// File: contracts/BullTycoons.sol
...
// File: contracts/BullTycoonsFactory.sol
...
contract BullTycoonsFactory is FactoryERC721, Ownable {
    ...
    IERC20 WETH = IERC20(wethAddress); //Polygon WETH used by Opensea
    ...
    modifier addressCanMint() {
        ...
        require(WETH.allowance(address(this), address(msg.sender)) >= PRESALE_AMOUNT, "Allowance not enough");
        _;
    }

    function presaleMint() public payable addressCanMint {
        BullTycoons bullTycoons = BullTycoons(nftAddress);
        WETH.transferFrom(msg.sender, address(this), PRESALE_AMOUNT);
...
// File: contracts/BullTycoonsFactoryMock.sol
